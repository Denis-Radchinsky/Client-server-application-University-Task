...
Задачи:
1. Реализовать простейшее клиент-серверное RMI или RPC приложение “HelloWorld”, заключающееся в отправке сообщения удаленному серверу и получения ответа от него
2. Реализовать локальную версию игры «Города» с возможностью игры на одном компьютере.
3. Реализовать сетевое клиент-серверное приложение – игру «Города», обеспечивающее подключение и работу с одним удаленным клиентом (игрок играет сам с собой).
4. Реализовать сетевое клиент-серверное приложение – игру «Города», обеспечивающее подключение и работу с набором удаленных клиентов, формирование и ведение нескольких одновременных сеансов игры.
